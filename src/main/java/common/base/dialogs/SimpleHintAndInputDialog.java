 ...
 * ******************(^_^)***********************
 */
public class SimpleHintAndInputDialog extends BaseDialog<SimpleHintAndInputDialog> {
    ...
    public SimpleHintAndInputDialog(Context context) {
     ...
     * @param theme
     */
    public SimpleHintAndInputDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    protected void initViews(View dialogView) {
        if (dialogView != null) {
            ...
            tvHint = dialogView.findViewById(R.id.edt_input_or_hint_text);
            if (tvHint != null) {
                tvHint.setText("");
            }
    ...
    protected int getDialogViewResID() {
        return R.layout.simple_input_hint_dialog;
    }

    public SimpleHintAndInputDialog withTitle(CharSequence dialogTitle) {
    ...
    public SimpleHintAndInputDialog withTitle(@StringRes int titleResId) {
        if (tvTitle != null) {
            tvTitle.setText(titleResId);
        }
        return self();
    }
    public SimpleHintAndInputDialog withDialogHint(CharSequence dialogHint) {
        if (tvHint != null) {
    ...
    public SimpleHintAndInputDialog withDialogHint(@StringRes int hintResId) {
        if (tvHint != null) {
            tvHint.setText(hintResId);
        }
        return self();
    }
    public SimpleHintAndInputDialog withCancelBtnText(CharSequence cancelBtnText) {
    ...
    public SimpleHintAndInputDialog withCancelBtnText(@StringRes int cancelBtnTextResId) {
        if (tvBtnCancel != null) {
            tvBtnCancel.setText(cancelBtnTextResId);
        }
        return self();
    }
    public SimpleHintAndInputDialog withCommitBtnText(CharSequence commitBtnText) {
    ...
    public SimpleHintAndInputDialog withCommitBtnText(@StringRes int commitBtnTextResId) {
        if (tvBtnCommit != null) {
    ...
    public SimpleHintAndInputDialog withCloseIcon(@DrawableRes int closeIconRes) {
        if (ivBtnClose != null) {
    ...
    public SimpleHintAndInputDialog withCloseIconVisible(boolean visible) {
        if (ivBtnClose != null) {
    ...
    public SimpleHintAndInputDialog visibleBottomBtns(boolean visible) {
    ...
    public SimpleHintAndInputDialog appendViews(View toAppendView) {
    ...
    @Override
    public SimpleHintAndInputDialog toggleCancelBtnVisibility(boolean hideCancelBtn) {
        if (tvBtnCancel != null) {
...
//            }
    ...
    @Override
    public SimpleHintAndInputDialog setHintMsg(String hintMsg) {
        if (tvHint != null) {
    ...
    @Override
    public SimpleHintAndInputDialog setHintMsgGravity(int gravity) {
        if (tvHint != null) {
    ...
    @Override
    public SimpleHintAndInputDialog setCancleBtnName(String cancleBtnName) {
        return withCancelBtnText(cancleBtnName);
    }

    @Override
    public SimpleHintAndInputDialog setCommitBtnName(String commitBtnName) {
        return withCommitBtnText(commitBtnName);
    }

//    public SimpleHintAndInputDialog useDialogHintWithScrollbar(boolean useHintWithScrollbar) {
//        if (tvHint != null) {
//            tvHint.setVisibility(View.GONE);
//        }
