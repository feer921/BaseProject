package common.base.glide.progress;
...
public class CircleProgressView extends ProgressBar {
    ...
    private int mReachBarSize = Util.dip2px(getContext(), 2); // 未完成进度条大小
    private int mNormalBarSize = Util.dip2px(getContext(), 2); // 未完成进度条大小
    ...
    private int mOuterSize = Util.dip2px(getContext(), 1); // 外层圆环宽度
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = Util.dip2px(getContext(), reachBarSize);
        invalidate();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = Util.dip2px(getContext(), normalBarSize);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        mRadius = Util.dip2px(getContext(), radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = Util.dip2px(getContext(), innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = Util.dip2px(getContext(), outerSize);
        invalidate();
    }
