...
public class Progress implements Serializable {
    ...
    public volatile float fraction;                          //下载的进度，0-1
    public volatile long totalSize;                          //总字节长度, byte
    public volatile long currentSize;                        //本次下载的大小, byte
    public transient long speed;                    //网速，byte/s
    public volatile int status;                              //当前状态
    public volatile int priority;                            //任务优先级
    ...
    private transient CopyOnWriteArrayList<Long> speedBuffer;       //网速做平滑的缓存，避免抖动过快
